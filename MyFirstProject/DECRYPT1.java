        ...
        s = s + " "; // adding a space at the end
            ...
            else
            {
                ...
                for(int i=0; i<l; i++)
                {
                     ...
                     */
                    a = (int ) ch1 + shift - 1; // storing ASCII values after adding shift to the current character
                    b = (int) ch2 + shift - 1; // storing ASCII values after adding shift to the next character
